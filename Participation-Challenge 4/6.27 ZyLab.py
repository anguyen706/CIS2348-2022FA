...
# 6.27 LAB*: Program: Drawing a half arrow
...
for index1 in range(arrow_base_height):
    for index2 in range(arrow_base_width):
        print('*', end='')
    print()
for index1 in range(arrow_head_width):
    for index2 in range(arrow_head_width - index1):
        print('*', end='')
    print()