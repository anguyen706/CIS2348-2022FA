...
# 6.26 LAB: Warm up: Drawing a right triangle
...
# a * character. Modify the given program to output a right triangle that
...
# Output a space after each user-specified character, including a line's last
